...
class ListaContactos:
    def __init__(self, nombre_lista_contacto=None, descripcion_lista_contacto=None,lista_contactos = [], fechaCreacion = None,ID_lista_contactos = None):
...
class ListaContactosController:
    ...
    def crear_lista_contactos(lista_contactos : ListaContactos):
        #Crea una lista de contactos sin contactos asignados

        lista = ListaContactos(lista_contactos.nombre_lista_contacto, lista_contactos.descripcion_lista_contacto)
    ...
    def agregarContactos(lista_contactos : ListaContactos):
        ...
        df['ID_LISTA_CONTACTOS'] = lista_contactos.ID_lista_contactos
        ...
        brevo = Brevo_contactos()
        lista_contactos_ids = [x.id_contacto for x in lista_contactos.Contactos]


        for i in range(0,len(lista_contactos_ids),150):
            brevo.post_contactos_form_lista_contactos(lista_contactos.ID_lista_contactos, lista_contactos_ids[i:i+150])
...
class ListaContactosModel():
    def getListaContactosDatos(ID_lista_contactos = None):
        ...
        if ID_lista_contactos != None:
            optionalWhere = " WHERE NOMBRE_LISTA_CONTACTOS = '{}'".format(ID_lista_contactos)
    ...
    def getListaContactos_Contactos(ID_lista_contactos = None):
        ...
        if ID_lista_contactos != None:
            optionalWhere = " AND NOMBRE_LISTA_CONTACTOS = '{}'".format(ID_lista_contactos)
            qwery = qwery + optionalWhere
